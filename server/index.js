...
app.put('/Studnt/:name',(req,res)=>{
    Student.findOneAndUpdate({name:req.body.name}, {$set:{givefeedback:req.body.givefeedback}},{new : true}).then(students=>{
        req.send(students)

    },
    console.log(req.body.name),
    console.log(req.body.givefeedback)
   //console.log('Success')
    ).catch((err)=>{
        res.send({
            message: "some error happened"
...
app.get('/teachers/:email',(req,res)=>{
  ...
  //for feedback
app.put('/Teacher/:name',(req,res)=>{
    Teacher.findOneAndUpdate({name:req.body.name}, {$set:{writeTeachFeed:req.body.writeTeachFeed}},{new : true}).then(teachers=>{
        req.send(teachers)
...
app.get('/attendance/:date',(req,res)=>{
    Attendance.find({date: req.params.date}).then(att=>{
        res.send(att)
    }).catch((err)=>{
        res.send({
            message: "some error happened"
